...
class __TwigTemplate_3a950c82775c675e3285af1bad4c22b6bb03c49e562c22c8e416f06174c02bdf extends Twig_Template
{
...
\t";
        // line 44
        if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "member", array()))) {
            // line 45
            echo "\t\t<ul class=\"topiclist two-columns\">
\t\t\t<li class=\"header\">
\t\t\t\t<dl>
...
";
        // line 78
        if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "pending", array()))) {
            // line 79
...
\t\t";
            // line 91
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "pending", array()));
...
";
        ...
        // line 112
        if (twig_length_filter($this->env, $this->getAttribute(($context["loops"] ?? null), "nonmember", array()))) {
            // line 113
            echo "<div class=\"panel\">
\t<div class=\"inner\">
\t\t<ul class=\"topiclist two-columns\">
...
\t\t";
            // line 125
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute(($context["loops"] ?? null), "nonmember", array()));
...
\t";
        // line 148
        if ((($context["S_CHANGE_DEFAULT"] ?? null) || ($this->getAttribute(($context["definition"] ?? null), "SHOW_BUTTONS", array()) == 1))) {
            // line 149
            echo "\t<fieldset>
\t\t";
            // line 150
...
\t\t";
            // line 157
            if (($this->getAttribute(($context["definition"] ?? null), "SHOW_BUTTONS", array()) == 1)) {
                // line 158

...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'phpbb.googleanalytics.listener' => 'getPhpbb_Googleanalytics_ListenerService',
            ...
            'stevotvr.flair.controller.acp.user' => 'getStevotvr_Flair_Controller_Acp_UserService',
            ...
            'threedi.tpotm.controller' => 'getThreedi_Tpotm_ControllerService',
            'threedi.tpotm.listener' => 'getThreedi_Tpotm_ListenerService',
            'threedi.tpotm.tpotm' => 'getThreedi_Tpotm_TpotmService',
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'bPb_oauth_tokens', 'bPb_oauth_states', 'bPb_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'bPb_users', $this, $this->get('dispatcher'), './', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'bPb_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'bPb_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './', 'php', 'bPb_forums', 'bPb_posts', 'bPb_topics', 'bPb_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('bPb_captcha_questions', 'bPb_captcha_answers', 'bPb_qa_confirm');
    ...
    protected function getDispatcherService()
    {
        ...
        $instance->addSubscriberService('phpbb.googleanalytics.listener', 'phpbb\\googleanalytics\\event\\listener');
        ...
        $instance->addSubscriberService('threedi.tpotm.listener', 'threedi\\tpotm\\event\\listener');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'bPb_ext', './', 'php', $this->get('cache'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './', 'adm/', 'php', 'bPb_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'bPb_migrations', './', 'php', 'bPb_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), $this->get('module.manager'), './', 'php', 'bPb_modules');
    }
    ...
    {
        return $this->services['module.manager'] = new \phpbb\module\module_manager($this->get('cache.driver'), $this->get('dbal.conn'), $this->get('ext.manager'), 'bPb_modules', './', 'php');
    }
    ...
    {
        return new \phpbb\notification\method\board($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('config'), 'bPb_notification_types', 'bPb_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\approve_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\bookmark($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\disapprove_topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\group_request($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    }
    ...
    {
        $instance = new \phpbb\notification\type\pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\post_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\quote($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_pm_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\report_post_closed($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        $instance = new \phpbb\notification\type\topic_in_queue($this->get('dbal.conn'), $this->get('language'), $this->get('user'), $this->get('auth'), './', 'php', 'bPb_user_notifications');
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('language'), $this->get('user'), 'bPb_notification_types', 'bPb_user_notifications');
    }
    ...
    /**
     * Gets the public 'phpbb.googleanalytics.listener' shared service.
     *
     * @return \phpbb\googleanalytics\event\listener
     */
    protected function getPhpbb_Googleanalytics_ListenerService()
    {
        return $this->services['phpbb.googleanalytics.listener'] = new \phpbb\googleanalytics\event\listener($this->get('config'), $this->get('template'), $this->get('user'));
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'bPb_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'bPb_profile_fields', 'bPb_profile_lang', 'bPb_profile_fields_data');
    }
    ...
    protected function getStevotvr_Flair_Controller_Acp_CatsService()
    {
        ...
        $instance->setup($this->get('stevotvr.flair.operator.category'));
    ...
    protected function getStevotvr_Flair_Controller_Acp_FlairService()
    {
        ...
        $instance->setup($this->get('dbal.conn'), $this->get('group_helper'), $this->get('stevotvr.flair.operator.category'), $this->get('stevotvr.flair.operator.flair'), $this->get('stevotvr.flair.operator.trigger'));
    ...
    /**
     * Gets the public 'stevotvr.flair.controller.acp.user' shared service.
     *
     * @return \stevotvr\flair\controller\acp_user_controller
     */
    protected function getStevotvr_Flair_Controller_Acp_UserService()
    {
        $this->services['stevotvr.flair.controller.acp.user'] = $instance = new \stevotvr\flair\controller\acp_user_controller($this, $this->get('language'), $this->get('request'), $this->get('template'));

        $instance->setup($this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('stevotvr.flair.operator.category'), $this->get('stevotvr.flair.operator.flair'), $this->get('stevotvr.flair.operator.user'));
        $instance->set_path_info('./', 'php');
    ...
    {
        return $this->services['stevotvr.flair.controller.legend'] = new \stevotvr\flair\controller\legend_controller($this->get('controller.helper'), $this->get('language'), $this->get('template'), $this->get('stevotvr.flair.operator.category'), $this->get('stevotvr.flair.operator.flair'));
    }
    ...
    {
        return new \stevotvr\flair\entity\category($this->get('dbal.conn'), 'bPb_flair_cats');
    }
    ...
    {
        $instance = new \stevotvr\flair\entity\flair($this->get('dbal.conn'), 'bPb_flair');
    ...
    {
        return $this->services['stevotvr.flair.listener'] = new \stevotvr\flair\event\main_listener($this->get('config'), $this->get('dbal.conn'), $this->get('controller.helper'), $this->get('language'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('stevotvr.flair.operator.trigger'), $this->get('stevotvr.flair.operator.user'));
    }
    ...
    {
        return $this->services['stevotvr.flair.operator.category'] = new \stevotvr\flair\operator\category($this, $this->get('dbal.conn'), 'bPb_flair', 'bPb_flair_cats', 'bPb_flair_groups', 'bPb_flair_triggers', 'bPb_flair_users');
    }
    ...
    {
        return $this->services['stevotvr.flair.operator.flair'] = new \stevotvr\flair\operator\flair($this, $this->get('dbal.conn'), 'bPb_flair', 'bPb_flair_cats', 'bPb_flair_groups', 'bPb_flair_triggers', 'bPb_flair_users');
    }
    ...
    {
        return $this->services['stevotvr.flair.operator.trigger'] = new \stevotvr\flair\operator\trigger($this, $this->get('dbal.conn'), 'bPb_flair', 'bPb_flair_cats', 'bPb_flair_groups', 'bPb_flair_triggers', 'bPb_flair_users');
    }
    ...
    {
        return $this->services['stevotvr.flair.operator.user'] = new \stevotvr\flair\operator\user($this, $this->get('dbal.conn'), 'bPb_flair', 'bPb_flair_cats', 'bPb_flair_groups', 'bPb_flair_triggers', 'bPb_flair_users');
    }
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000002cfde470000000005d593ef0(
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access($this->get('dbal.conn'), 'bPb_bbcodes', 'bPb_smilies', 'bPb_styles', 'bPb_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description($this->get('dbal.conn'), 'bPb_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules($this->get('dbal.conn'), 'bPb_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description($this->get('dbal.conn'), 'bPb_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text($this->get('dbal.conn'), 'bPb_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title($this->get('dbal.conn'), 'bPb_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text($this->get('dbal.conn'), 'bPb_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature($this->get('dbal.conn'), 'bPb_users');
    ...
    /**
     * Gets the public 'threedi.tpotm.controller' shared service.
     *
     * @return \threedi\tpotm\controller\main
     */
    protected function getThreedi_Tpotm_ControllerService()
    {
        return $this->services['threedi.tpotm.controller'] = new \threedi\tpotm\controller\main($this->get('auth'), $this->get('dbal.conn'), $this->get('config'), $this->get('controller.helper'), $this->get('pagination'), $this->get('request'), $this->get('template'), $this->get('user'), $this->get('threedi.tpotm.tpotm'), 'php', './');
    }

    /**
     * Gets the public 'threedi.tpotm.listener' shared service.
     *
     * @return \threedi\tpotm\event\listener
     */
    protected function getThreedi_Tpotm_ListenerService()
    {
        return $this->services['threedi.tpotm.listener'] = new \threedi\tpotm\event\listener($this->get('request'), $this->get('controller.helper'), $this->get('template'), $this->get('user'), 'php', $this->get('threedi.tpotm.tpotm'));
    }

    /**
     * Gets the public 'threedi.tpotm.tpotm' shared service.
     *
     * @return \threedi\tpotm\core\tpotm
     */
    protected function getThreedi_Tpotm_TpotmService()
    {
        return $this->services['threedi.tpotm.tpotm'] = new \threedi\tpotm\core\tpotm($this->get('auth'), $this->get('cache'), $this->get('config'), $this->get('dbal.conn'), $this->get('user'), $this->get('path_helper'), './', 'php', $this->get('template'), $this->get('ext.manager'));
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './', 'php', 'bPb_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'tables.acl_groups' => 'bPb_acl_groups',
            'tables.acl_options' => 'bPb_acl_options',
            'tables.acl_roles' => 'bPb_acl_roles',
            'tables.acl_roles_data' => 'bPb_acl_roles_data',
            'tables.acl_users' => 'bPb_acl_users',
            'tables.attachments' => 'bPb_attachments',
            'tables.auth_provider_oauth_token_storage' => 'bPb_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'bPb_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'bPb_oauth_accounts',
            'tables.banlist' => 'bPb_banlist',
            'tables.bbcodes' => 'bPb_bbcodes',
            'tables.bookmarks' => 'bPb_bookmarks',
            'tables.bots' => 'bPb_bots',
            'tables.captcha_qa_questions' => 'bPb_captcha_questions',
            'tables.captcha_qa_answers' => 'bPb_captcha_answers',
            'tables.captcha_qa_confirm' => 'bPb_qa_confirm',
            'tables.config' => 'bPb_config',
            'tables.config_text' => 'bPb_config_text',
            'tables.confirm' => 'bPb_confirm',
            'tables.disallow' => 'bPb_disallow',
            'tables.drafts' => 'bPb_drafts',
            'tables.ext' => 'bPb_ext',
            'tables.extensions' => 'bPb_extensions',
            'tables.extension_groups' => 'bPb_extension_groups',
            'tables.forums' => 'bPb_forums',
            'tables.forums_access' => 'bPb_forums_access',
            'tables.forums_track' => 'bPb_forums_track',
            'tables.forums_watch' => 'bPb_forums_watch',
            'tables.groups' => 'bPb_groups',
            'tables.icons' => 'bPb_icons',
            'tables.lang' => 'bPb_lang',
            'tables.log' => 'bPb_log',
            'tables.login_attempts' => 'bPb_login_attempts',
            'tables.migrations' => 'bPb_migrations',
            'tables.moderator_cache' => 'bPb_moderator_cache',
            'tables.modules' => 'bPb_modules',
            'tables.notification_types' => 'bPb_notification_types',
            'tables.notifications' => 'bPb_notifications',
            'tables.poll_options' => 'bPb_poll_options',
            'tables.poll_votes' => 'bPb_poll_votes',
            'tables.posts' => 'bPb_posts',
            'tables.privmsgs' => 'bPb_privmsgs',
            'tables.privmsgs_folder' => 'bPb_privmsgs_folder',
            'tables.privmsgs_rules' => 'bPb_privmsgs_rules',
            'tables.privmsgs_to' => 'bPb_privmsgs_to',
            'tables.profile_fields' => 'bPb_profile_fields',
            'tables.profile_fields_data' => 'bPb_profile_fields_data',
            'tables.profile_fields_options_language' => 'bPb_profile_fields_lang',
            'tables.profile_fields_language' => 'bPb_profile_lang',
            'tables.ranks' => 'bPb_ranks',
            'tables.reports' => 'bPb_reports',
            'tables.reports_reasons' => 'bPb_reports_reasons',
            'tables.search_results' => 'bPb_search_results',
            'tables.search_wordlist' => 'bPb_search_wordlist',
            'tables.search_wordmatch' => 'bPb_search_wordmatch',
            'tables.sessions' => 'bPb_sessions',
            'tables.sessions_keys' => 'bPb_sessions_keys',
            'tables.sitelist' => 'bPb_sitelist',
            'tables.smilies' => 'bPb_smilies',
            'tables.sphinx' => 'bPb_sphinx',
            'tables.styles' => 'bPb_styles',
            'tables.styles_template' => 'bPb_styles_template',
            'tables.styles_template_data' => 'bPb_styles_template_data',
            'tables.styles_theme' => 'bPb_styles_theme',
            'tables.styles_imageset' => 'bPb_styles_imageset',
            'tables.styles_imageset_data' => 'bPb_styles_imageset_data',
            'tables.teampage' => 'bPb_teampage',
            'tables.topics' => 'bPb_topics',
            'tables.topics_posted' => 'bPb_topics_posted',
            'tables.topics_track' => 'bPb_topics_track',
            'tables.topics_watch' => 'bPb_topics_watch',
            'tables.user_group' => 'bPb_user_group',
            'tables.user_notifications' => 'bPb_user_notifications',
            'tables.users' => 'bPb_users',
            'tables.warnings' => 'bPb_warnings',
            'tables.words' => 'bPb_words',
            'tables.zebra' => 'bPb_zebra',
            ...
            'stevotvr.flair.tables.flair' => 'bPb_flair',
            'stevotvr.flair.tables.flair_categories' => 'bPb_flair_cats',
            'stevotvr.flair.tables.flair_groups' => 'bPb_flair_groups',
            'stevotvr.flair.tables.flair_triggers' => 'bPb_flair_triggers',
            'stevotvr.flair.tables.flair_users' => 'bPb_flair_users',
            'stevotvr.flair.trigger_names' => array(
                0 => 'post_count',
                1 => 'membership_days',
            ),
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'bPb_',
...
class phpbbtemplatetwiglexer_000000002cfde470000000005d593ef0 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5ab62d98e02c0766265162 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5ab62d98e02d0265872187 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5ab62d98e028d398943307 = array(
    ...
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, 'set_environment', array('env' => $env), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;

        return $this->valueHolder5ab62d98e02c0766265162->set_environment($env);
    }
    ...
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;

        return $this->valueHolder5ab62d98e02c0766265162->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;

        return $this->valueHolder5ab62d98e02c0766265162->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5ab62d98e02d0265872187 = $initializer;
    }
    ...
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, '__get', array('name' => $name), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;

        if (isset(self::$publicProperties5ab62d98e028d398943307[$name])) {
            return $this->valueHolder5ab62d98e02c0766265162->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5ab62d98e02c0766265162;
    ...
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;
    ...
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, '__isset', array('name' => $name), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;
    ...
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, '__unset', array('name' => $name), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;
    ...
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, '__clone', array(), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;

        $this->valueHolder5ab62d98e02c0766265162 = clone $this->valueHolder5ab62d98e02c0766265162;
    }

    public function __sleep()
    {
        $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, '__sleep', array(), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;

        return array('valueHolder5ab62d98e02c0766265162');
    }
    ...
    {
        return $this->initializer5ab62d98e02d0265872187;
    }
    ...
    {
        return $this->initializer5ab62d98e02d0265872187 && ($this->initializer5ab62d98e02d0265872187->__invoke($valueHolder5ab62d98e02c0766265162, $this, 'initializeProxy', array(), $this->initializer5ab62d98e02d0265872187) || 1) && $this->valueHolder5ab62d98e02c0766265162 = $valueHolder5ab62d98e02c0766265162;
    }
    ...
    {
        return null !== $this->valueHolder5ab62d98e02c0766265162;
    }
    ...
    {
        return $this->valueHolder5ab62d98e02c0766265162;
    }
